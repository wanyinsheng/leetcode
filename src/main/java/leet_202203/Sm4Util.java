...
public class Sm4Util {
    ...
    public static final String ALGORITHM_NAME_ECB_PADDING = "SM4/ECB/PKCS5Padding";//SM4/ECB/PKCS5Padding
    ...
    public static void main(String[] args) throws NoSuchPaddingException, NoSuchAlgorithmException {
        ...
        while(n-->0) {
            ...
            Cipher instance = Cipher.getInstance(("SM4/ECB/PKCS5Padding"));
